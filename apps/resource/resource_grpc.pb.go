...
const (
	RPC_Search_FullMethodName    = "/course.cmdb.resource.RPC/Search"
	RPC_QueryTag_FullMethodName  = "/course.cmdb.resource.RPC/QueryTag"
	RPC_UpdateTag_FullMethodName = "/course.cmdb.resource.RPC/UpdateTag"
)
...
func (c *rPCClient) QueryTag(ctx context.Context, in *QueryTagRequest, opts ...grpc.CallOption) (*TagSet, error) {
	out := new(TagSet)
	err := c.cc.Invoke(ctx, RPC_QueryTag_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCClient) UpdateTag(ctx context.Context, in *UpdateTagRequest, opts ...grpc.CallOption) (*Resource, error) {
	out := new(Resource)
	err := c.cc.Invoke(ctx, RPC_UpdateTag_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RPC_QueryTag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RPC_QueryTag_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RPC_UpdateTag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RPC_UpdateTag_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "course.cmdb.resource.RPC",
